...
# Space Station Viewer: An Alexa Skill Lambda function
...
from alexa import data, service
...
class NextPassIntentHandler(AbstractRequestHandler):
    """Handler for next pass intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return is_intent_name("NextPass")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        logger.info("In  NextPassIntentHandler")
